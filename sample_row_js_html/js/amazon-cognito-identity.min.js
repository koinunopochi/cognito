  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var o = n(1),
        ...
        l = (function () {
          ...
          return (
            (e.prototype.getSmallAValue = function () {
            ...
            (e.prototype.generateHashDevice = function (e, t, n) {
              ...
              (this.SaltToHashDevices = this.padHex(new a.default(u, 16))),
                this.g.modPow(
                  new a.default(this.hexHash(this.SaltToHashDevices + r), 16),
                  this.N,
                  function (e, t) {
                    e && n(e, null),
            ...
            (e.prototype.calculateA = function (e, t) {
              ...
              this.g.modPow(e, this.N, function (e, i) {
                e && t(e, null),
                  i.mod(n.N).equals(a.default.ZERO) &&
                    t(
            ...
            (e.prototype.getPasswordAuthenticationKey = function (
              e,
              t,
              n,
              i,
              ...
              this.calculateS(l, n, function (e, t) {
                e && s(e, null);
                var n = r.computehkdf(
                  new o.util.Buffer(r.padHex(t), 'hex'),
                  new o.util.Buffer(r.padHex(r.UValue.toString(16)), 'hex')
                );
                s(null, n);
              });
            }),
            (e.prototype.calculateS = function (e, t, n) {
              ...
              this.g.modPow(e, this.N, function (s, o) {
                ...
                r.modPow(
                  i.smallAValue.add(i.UValue.multiply(e)),
                  i.N,
                  function (e, t) {
    ...
    function (e, t) {
      ...
      function p(e) {
        ...
        if (r-- > 0)
          for (
            u < this.DB && (n = this[r] >> u) > 0 && ((s = !0), (o = a(n)));
            r >= 0;

          )
            u < t
              ? ((n = (this[r] & ((1 << u) - 1)) << (t - u)),
                (n |= this[--r] >> (u += this.DB - t)))
              : ((n = (this[r] >> (u -= t)) & i),
                u <= 0 && ((u += this.DB), --r)),
              n > 0 && (s = !0),
              s && (o += a(n));
      ...
      function I(e, t, s) {
        ...
        if (!(o.t <= 0)) {
          ...
          var a = i(),
            ...
            l = this.DB - m(o[o.t - 1]);
          l > 0
            ? (o.lShiftTo(l, a), r.lShiftTo(l, s))
            : (o.copyTo(a), r.copyTo(s));
          var h = a.t,
            f = a[h - 1];
          if (0 != f) {
            ...
            for (
              a.dlShiftTo(C, y),
                s.compareTo(y) >= 0 && ((s[s.t++] = 1), s.subTo(y, s)),
                n.ONE.dlShiftTo(h, y),
                y.subTo(a, a);
              a.t < h;
            ...
            for (; --C >= 0; ) {
              var U =
                s[--S] == f
                  ? this.DM
                  : Math.floor(s[S] * p + (s[S - 1] + v) * g);
              if ((s[S] += a.am(0, U, s, C, 0, h)) < U)
                for (a.dlShiftTo(C, y), s.subTo(y, s); s[S] < --U; )
                  s.subTo(y, s);
            }
            null != t && (s.drShiftTo(h, t), u != c && n.ZERO.subTo(t, t)),
              (s.t = h),
              s.clamp(),
              l > 0 && s.rShiftTo(l, s),
      ...
      function j(e, t, n) {
        ...
        for (o = m(e[v]) - 1; v >= 0; ) {
          for (
            ...
            (p >>= 1), --c;
          if (((o -= c) < 0 && ((o += this.DB), --v), S))
            u[p].copyTo(r), (S = !1);
          else {
            for (; c > 1; ) a.sqrTo(r, C), a.sqrTo(C, r), (c -= 2);
            c > 0 ? a.sqrTo(r, C) : ((g = r), (r = C), (C = g)),
              a.mulTo(C, u[p], r);
          }
          for (; v >= 0 && 0 == (e[v] & (1 << o)); )
            a.sqrTo(r, C),
      ...
      W && L && 'Microsoft Internet Explorer' == navigator.appName
        ? ((n.prototype.am = o), (H = 30))
        : W && L && 'Netscape' != navigator.appName
        ? ((n.prototype.am = s), (H = 26))
        : ((n.prototype.am = r), (H = 28)),
        (n.prototype.DB = H),
    ...
    function (e, t, n) {
      ...
      var s = n(1),
        o = (function () {
          ...
          return (
            (e.prototype.getJwtToken = function () {
    ...
    function (e, t, n) {
      ...
      var o = n(1),
        ...
        T = (function () {
          ...
          return (
            (e.prototype.setSignInUserSession = function (e) {
                ...
                this.client.makeUnauthenticatedRequest(
                  ...
                  function (e, i) {
                    ...
                    return 'CUSTOM_CHALLENGE' === s
                      ? ((n.Session = i.Session), t.customChallenge(o))
              ...
              null != this.deviceKey && (l.DEVICE_KEY = this.deviceKey),
                ...
                i.getLargeAValue(function (c, h) {
                  c && t.onFailure(c),
                    ...
                    'CUSTOM_AUTH' === n.authenticationFlowType &&
                  ...
                  n.getUserContextData(n.username) &&
                    (f.UserContextData = n.getUserContextData(n.username)),
            ...
            (e.prototype.authenticateUserInternal = function (e, t, n) {
              ...
              if ('SELECT_MFA_TYPE' === s)
                return (this.Session = e.Session), n.selectMFAType(s, r);
              if ('MFA_SETUP' === s)
                return (this.Session = e.Session), n.mfaSetup(s, r);
              if ('SOFTWARE_TOKEN_MFA' === s)
                return (this.Session = e.Session), n.totpRequired(s, r);
              ...
              return null == a
                ? n.onSuccess(this.signInUserSession)
                : void t.generateHashDevice(
                    ...
                    function (s) {
                      ...
                      (i.verifierDevices = r.PasswordVerifier),
                        ...
                        i.client.makeUnauthenticatedRequest(
                          'confirmDevice',
                          {
            ...
            (e.prototype.getDeviceResponse = function (e) {
              ...
              (s.USERNAME = this.username),
                ...
                n.getLargeAValue(function (r, u) {
                  ...
                  t.getUserContextData() &&
                    (c.UserContextData = t.getUserContextData()),
                      ...
                      function (s, r) {
                        ...
                        n.getPasswordAuthenticationKey(
                          ...
                          function (n, s) {
                            ...
                            t.getUserContextData() &&
                              (h.UserContextData = t.getUserContextData()),
                              t.client.makeUnauthenticatedRequest(
                                'respondToAuthChallenge',
                                h,
                                function (n, i) {
              ...
              this.getUserContextData() &&
                ...
                this.client.makeUnauthenticatedRequest(
                  ...
                  function (e, i) {
                    return e
                      ? t.onFailure(e)
                      : n.authenticateUserInternal(i, s, t);
                  }
                );
            }),
            ...
            (e.prototype.forgotPassword = function (e) {
              ...
              this.getUserContextData() &&
                (t.UserContextData = this.getUserContextData()),
                this.client.makeUnauthenticatedRequest(
                  'forgotPassword',
                  t,
                  function (t, n) {
                ...
                : this.client.makeUnauthenticatedRequest(
                    ...
                    function (e, t) {
                      ...
                      i.getUserContextData() &&
                        (o.UserContextData = i.getUserContextData()),
                        i.client.makeUnauthenticatedRequest(
                          'respondToAuthChallenge',
                          o,
                          function (e, t) {
    ...
    function (e, t, n) {
      ...
      var o = n(13),
        ...
        h = (function () {
          ...
          return (
            (e.prototype.getUserPoolId = function () {
            ...
            (e.prototype.signUp = function (e, t, n, i, s) {
              ...
              this.getUserContextData(e) &&
                (r.UserContextData = this.getUserContextData(e)),
                this.client.makeUnauthenticatedRequest(
                  'signUp',
                  r,
                  function (t, n) {
                    if (t) return s(t, null);
                    var i = { Username: e, Pool: o, Storage: o.storage },
                      r = {
        ...
        a = (function () {
          function e(t) {
            s(this, e),
              ...
              Object.prototype.hasOwnProperty.call(t, 'expires')
                ? (this.expires = t.expires)
                : (this.expires = 365),
              Object.prototype.hasOwnProperty.call(t, 'secure')
              ...
              for (
                ...
                try {
                  ...
                  if (
                    ((p = n.read
                      ? n.read(p, g)
                      : n(p, g) || p.replace(h, decodeURIComponent)),
                    this.json)
                  )
                    try {
                      p = JSON.parse(p);
