        ...
        b.exports = {
          ...
          operations: {
            ...
            AdminUpdateUserAttributes: {
              ...
              documentation:
                "<p>Updates the specified user's attributes, including developer attributes, as an administrator. Works on any user.</p> <p>In addition to updating user attributes, this API can also be used to mark phone and email as verified.</p> <p>Requires developer credentials.</p>",
            },
            ...
            Authenticate: {
              ...
              documentation:
                '<p>The second step in the authentication flow of Secure Remote Password protocol (SRP) for authenticating a user to get ID, access and refresh tokens. To learn more about the first step, see <a href="API_GetAuthenticationDetails.html">GetAuthenticationDetails</a>.</p>',
              authtype: 'none',
            },
            ChangePassword: {
              name: 'ChangePassword',
            ...
            EnhanceAuth: {
              ...
              documentation:
                '<p>Grants the ability to supply a multi-factor authentication (MFA) token for an MFA-enabled user to get the ID, access, and refresh tokens.</p>',
              authtype: 'none',
            },
            ForgetDevice: {
              name: 'ForgetDevice',
            ...
            GetAuthenticationDetails: {
              ...
              documentation:
                '<p>First step of the Secure Remote Password protocol (SRP) auth flow to authenticate a user. To learn about the second step, see <a href="API_Authenticate.html">Authenticate</a>.</p>',
              authtype: 'none',
            },
            GetCSVHeader: {
              name: 'GetCSVHeader',
          ...
          shapes: {
            ...
            AdminCreateUserConfigType: {
              ...
              members: {
                ...
                UnusedAccountValidityDays: {
                  ...
                  documentation:
                    '<p>The user account expiration limit, in days, after which the account is no longer usable. To reset the account after that time limit, you must call AdminCreateUser again, specifying "RESEND" for the MessageAction parameter. The default value for this parameter is 7.</p>',
                },
            ...
            AttributeValueType: { type: 'string', max: 2048, sensitive: !0 },
            AuthEventType: {
              type: 'structure',
              members: {
            ...
            AuthenticateResponse: {
              ...
              members: {
                ...
                CodeDeliveryDetails: {
                  ...
                  documentation:
                    '<p>The code delivery details returned by the server in the response to the authentication request.</p>',
                },
              },
            ...
            BotActionType: {
              ...
              members: { EventAction: { shape: 'BotEventActionType' } },
            },
            BotActionsType: {
              type: 'structure',
              members: {
            ...
            ChallengeName: { type: 'string', enum: ['Password', 'Mfa'] },
            ChallengeNameType: {
              type: 'string',
              enum: [
                'SMS_MFA',
            ...
            EnhanceAuthRequest: {
              ...
              documentation:
                '<p>Represents the request by the developer to enhance the authentication on a user pool.</p>',
            },
            EnhanceAuthResponse: {
              type: 'structure',
              members: {
            ...
            FeedbackValueType: { type: 'string', enum: ['Bad', 'Good'] },
            ...
            GetAuthenticationDetailsRequest: {
              ...
              members: {
                ...
                Username: {
                  shape: 'UsernameType',
                  documentation:
                    '<p>The user name of the user for whom you wish to retrieve authentication details.</p>',
                },
                SrpA: {
                  shape: 'AValueHexStringType',
                  documentation:
                    '<p>The Secure Remote Password protocol (SRP) key. For more information, see <a href="https://en.wikipedia.org/wiki/Secure_Remote_Password_protocol">Secure Remote Password Protocol</a>.</p>',
                },
                ValidationData: {
                  shape: 'AttributeListType',
                  documentation:
            ...
            GetAuthenticationDetailsResponse: {
              ...
              members: {
                Salt: {
                  shape: 'HexStringType',
                  documentation:
                    '<p>A salt that gets returned by the response from the server to get authentication details. For more information, see <a href="https://en.wikipedia.org/wiki/Salt_%28cryptography%29">Salt cryptography</a>.</p>',
                },
                SrpB: {
                  shape: 'HexStringType',
                  documentation:
                ...
                SecretBlock: {
                  shape: 'BlobType',
                  documentation:
                    '<p>A blob that blocks the secret hash in the get authentication details response.</p>',
                },
                Username: {
                  shape: 'UsernameType',
                  documentation:
                    '<p>The resolved username for a possible alias in the input username parameter.</p>',
                },
              },
              documentation:
            ...
            GetJWKSResponse: {
              ...
              members: {
                ...
                cacheControl: {
                  shape: 'StringType',
                  documentation:
                    '<p>The value of the <code>Cache-Control</code> HTTP header field for the JSON Web keys response. For more information on <code>cacheControl</code>, see <a href="https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9">https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.9</a>.</p>',
                },
              },
              documentation:
            ...
            GetOpenIdConfigurationRequest: {
              ...
              members: {
                UserPoolId: {
                  shape: 'UserPoolIdType',
                  documentation:
                    '<p>The user pool ID for the user pool where you want to get Open ID configuration information.</p>',
                },
              },
              documentation:
            ...
            GetOpenIdConfigurationResponse: {
              ...
              members: {
                ...
                jwks_uri: {
                  shape: 'openIdUrlType',
                  documentation:
                    '<p>The URI of the JSON Web keys in the server response to get Open ID configuration information.</p>',
                },
                authorization_endpoint: {
                  shape: 'openIdUrlType',
                  documentation:
                    '<p>The authorization endpoint returned by the server response to get the Open ID configuration information.</p>',
                },
                subject_types_supported: {
                  shape: 'openIdListType',
                  documentation:
                    '<p>The subject types supported returned by the server response to get the Open ID configuration information.</p>',
                },
                response_types_supported: {
                  shape: 'openIdListType',
                  documentation:
                    '<p>The response types supported returned by the server response to get the Open ID configuration information.</p>',
                },
                id_token_signing_alg_values_supported: {
                  shape: 'openIdListType',
                  documentation:
                    '<p>The token-signing algorithm values supported returned by the server response to get the Open ID configuration information.</p>',
                },
              },
              documentation:
                '<p>Represents the response from the server to get the Open ID configuration information.</p>',
            },
            ...
            GetSigningCertificateResponse: {
              type: 'structure',
              members: { Certificate: { shape: 'StringType' } },
            },
            ...
            HexStringType: { type: 'string', pattern: '^[0-9a-fA-F]+$' },
            HttpHeader: {
              type: 'structure',
              members: {
            ...
            KeyListType: { type: 'list', member: { shape: 'KeyType' } },
            KeyType: {
              type: 'structure',
              members: {
                kty: {
                  shape: 'StringType',
                  documentation:
                    '<p>A "kty" key type parameter. For more information, see <a href="http://self-issued.info/docs/draft-ietf-jose-json-web-key.html">JSON Web Key (JWK) Format</a>.</p>',
                },
                alg: {
                  shape: 'StringType',
                  documentation:
                    '<p>A "kty" (Key Type) parameter. For more information, see <a href="http://self-issued.info/docs/draft-ietf-jose-json-web-key.html#ktyDef">"kty" (Key Type) Parameter</a>.</p>',
                },
                use: {
                  shape: 'StringType',
                  documentation:
                    '<p>A "use" (Public Key Use) parameter. For more information, see <a href="http://self-issued.info/docs/draft-ietf-jose-json-web-key.html#useDef">"use" (Public Key Use) Parameter</a>.</p>',
                },
                kid: {
                  shape: 'StringType',
                  documentation:
                    '<p>A "kid" (Key ID) parameter. For more information, see <a href="http://self-issued.info/docs/draft-ietf-jose-json-web-key.html#kidDef">"kid" (Key ID) Parameter</a>.</p>',
                },
                n: {
                  shape: 'StringType',
            ...
            RefreshTokensResponse: {
              ...
              members: {
                AuthenticationResult: {
                  shape: 'AuthenticationResultType',
                  documentation:
                    "<p>The authentication result from the server's response to the request to refresh tokens.</p>",
                },
              },
              documentation:
                '<p>Represents the response from the server when the user wants to refresh tokens.</p>',
            },
            ...
            SoftwareTokenMfaConfigType: {
              type: 'structure',
              members: { Enabled: { shape: 'BooleanType' } },
            },
            ...
            UserContextDataType: {
              type: 'structure',
              members: { encodedData: { shape: 'StringType' } },
            },
            ...
            openIdListType: { type: 'list', member: { shape: 'StringType' } },
            openIdUrlType: {
              type: 'string',
              max: 150,
              min: 1,
